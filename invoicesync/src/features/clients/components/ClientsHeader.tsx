...
type ClientsHeaderProps = React.HTMLAttributes<HTMLDivElement> & {
  onCreateClick: () => void
}

const ClientsHeader = React.forwardRef<HTMLDivElement, ClientsHeaderProps>(({ onCreateClick, className, ...props }, ref) => (
